...
public class JsonUtils {
    ...
    public static <T> T fromJson(String json, Class<T> clazz, String datePattern) {
        ...
        try {
            ...
            Log.e("", json + " 无法转换为 " + clazz.getName() + " 对象!", ex);
            return null;
        }
    }
    ...
    /**
     * to simple Gson String
     *
     * @param target
     * @return
     */
    public static String toSimpleGson(Object target) {
        return toSimpleGson(target, null);
    }
     ...
     * @return
     */
    public static String toSimpleGson(Object target, Type targetType) {
        String result;
