 ...
 * @author gaoxiaohui
 */
public class CBindingListAdapter<T> extends BaseBindingListAdapter<T> implements IHeaderFooterAdapter<T> {
    ...
    public CBindingListAdapter(Context context, DiffUtil.ItemCallback<T> diffCallback) {
        super(context,diffCallback);
    }

    public CBindingListAdapter(Context context, int layoutId, DiffUtil.ItemCallback<T> diffCallback) {
        super(context, layoutId,diffCallback);
    }

    public CBindingListAdapter(Context context, int layoutId, List<T> datas, DiffUtil.ItemCallback<T> diffCallback) {
        super(context, layoutId, datas,diffCallback);
    }

    @Override
    public CBindingListAdapter<T> layout(int layoutId) {
        this.mLayoutId = layoutId;
        return this;
    }

    @Override
    public CBindingListAdapter<T> list(List<T> datas) {
        super.list(datas);
        return this;
    }

    @Override
    public CBindingListAdapter<T> bindViewAndData(IConverter<? super T> converter) {
    ...
    @Override
    public CBindingListAdapter<T> addHeaderView(View headerView) {
    ...
    @Override
    public CBindingListAdapter<T> removeHeaderView(View headerView) {
    ...
    @Override
    public CBindingListAdapter<T> addFooterView(View footerView) {
    ...
    @Override
    public CBindingListAdapter<T> removeFooterView(View footerView) {
    ...
    /* <!---- multiItem support ----> */
    @Override
    public CBindingListAdapter<T> multiItemTypeSupport(MultiItemTypeSupport<T> multiItemTypeSupport) {
    ...
    public CBindingListAdapter<T> animationSupport(boolean enabled) {
        this.animationEnabled = enabled;
        return this;
    }

    public CBindingListAdapter<T> animationSupport(boolean enabled, boolean firstOnlyEnable
