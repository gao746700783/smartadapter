...
public class DividerItemDecorationEx extends RecyclerView.ItemDecoration {
     ...
     */
    public DividerItemDecorationEx(Context context, int orientation, int drawableId) {
        this.setOrientation(orientation);
...
//        KLog.e("mDividerHeight", mDividerHeight + "===================");
        //抗锯齿画笔
    ...
    public DividerItemDecorationEx(Context context, int orientation, int dividerHeight,
                                   String dividerColor) {
        this.setOrientation(orientation);
        mDividerHeight = dividerHeight;
        ...
        //抗锯齿画笔
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        int color = Color.parseColor(dividerColor);
